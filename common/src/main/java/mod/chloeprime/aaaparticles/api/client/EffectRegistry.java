...
public class EffectRegistry {
     ...
     * @since 2.1.0
     */
    public static CompletableFuture<@NotNull EffectDefinition> load(ResourceLocation id) {
     ...
     * @since 2.1.0
     */
    public static CompletableFuture<Optional<EffectDefinition>> tryLoad(ResourceLocation id) {
